data "akamai_cloudlets_edge_redirector_match_rule" "match_rules_er_qa" {

  match_rules {
    name  = "QA Env specific redirect #1"
    start = 0
    end   = 0
    matches {
      match_type     = "protocol"
  ...
  match_rules {
    name  = "QA Env specific redirect #2"
    start = 0
    end   = 0
    matches {
      match_type     = "protocol"
  ...
  match_rules {
    name  = "QA Env specific redirect #3"
    start = 0
    end   = 0
    matches {
      match_type     = "protocol"
  ...
  match_rules {
    name  = "QA Env specific redirect #4"
    start = 0
    end   = 0
    matches {
      match_type     = "path"
